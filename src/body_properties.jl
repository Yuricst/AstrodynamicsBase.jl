...
# Arguments
    - `naifIDs::String`: tuple containing strings of naif ID to use to extract GM values. Multiple naifIDs may be passed in a single function call.

# Returns
    - `Vector`: lst of GM values
...
Examples:
```julia-repl
julia> get_semiMajorAxes("399", "301")
